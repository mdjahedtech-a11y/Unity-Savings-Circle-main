                    ...
                    >
                       <div className="flex items-center gap-3 mb-6">
                        <motion.button 
                          ...
                          disabled={loading}
                          className={cn(
                            "p-2 rounded-xl bg-white/10 backdrop-blur-md text-white transition-all border border-white/20",
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
              <div className="h-full p-5 md:p-6 rounded-3xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 shadow-sm hover:shadow-xl hover:shadow-emerald-500/10 transition-all group overflow-hidden relative">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Savings Age</span>
                </div>
                <SavingsAgeCounter />
              </div>
            </motion.div>
